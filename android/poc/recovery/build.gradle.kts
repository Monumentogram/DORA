    ...
    doLast {
        ...
        val forbiddenIdentifiers =
            listOf(
                ...
                "getPrimary().getKey().toString()",
                "getPrimary().getKey().getParameters().toString()",
            )
        ...
        val requiredSourceFragments =
            listOf(
                ...
                "getPrimary().getKey().getParameters()",
                ...
                "ObservingDecryptAead(primitive)",
        ...
        val report =
            mapOf(
                ...
                "exactPrimaryParameterValidationPresent" to true,
                "neutralDecryptFailureSignalsPresent" to true,
                "observingEncryptedKeysetParseBoundaryPresent" to true,
                "observingProxyRetainsPayloadReferences" to false,
                "manualCleartextKeysetParsingPresent" to false,
