...
def validate_decisions() -> None:
    ...
    expected_ids = [f"DEC-{index:03d}" for index in range(1, 46)]
    if ids != expected_ids:
        fail(f"Expected ordered product decisions DEC-001 through DEC-045, found {ids}")
...
def validate_governance() -> None:
    required_files = (
        ...
        "docs/evidence/poc-recovery-001/review-findings-v0.6.json",
        "docs/evidence/poc-recovery-001/advisory-engineering-security-dossier-2026-08-13.md",
        "docs/evidence/poc-recovery-001/formal-engineering-security-review-2026-08-13.json",
