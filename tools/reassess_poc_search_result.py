...
ASSESSMENT_ID = "review-2026-08-11-v2"
ASSESSMENT_ISSUED_AT = "2026-08-11T15:11:53Z"
...
def render_assessment(repo_root: Path, output_dir: Path) -> dict[Path, dict[str, Any]]:
    ...
    index = {
        ...
        "gateContract": {
            ...
            "complete": False,
            "blocker": (
                "Storage/update is an approved mandatory failure category, but no prospective "
                "numeric threshold exists. Owner-approved normative clarification is required."
            ),
        },
        "ipEvaluation": {
