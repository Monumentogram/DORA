...
| POC-DATA-001 | BLOCKED | L | RU/EN/mixed corpus governance and manifest | `OD-03`/`OD-04`/`OD-08`/`OD-09`; controlled storage/custodian/consent process | foundation in `docs/stage0/DORA_MVP1_DATASET_GOVERNANCE.md`; merged repository-owned [synthetic-public manifest profile validator evidence](evidence/poc-data-001/synthetic-public-manifest-validator-local-evidence-stage0-v0.1.json); combined [host-oracle publication closure](evidence/stage0-host-oracle-publication-closure-2026-08-18.json) | the pure-host validator proves only deterministic synthetic metadata/profile rules; no governed manifest, dataset, custodian, consented record or collection exists. Purpose-recorded data remains blocked until consent/private store/access/deletion controls; real meetings and training are prohibited |
...
| POC-VAD-001 | BLOCKED | L | 90 s silence/max-cap deterministic replay | POC-GATES-001, POC-DATA-001 | merged deterministic [P2 frame-timing host-oracle evidence](evidence/poc-vad-001/p2-host-oracle-local-evidence-stage0-v0.1.json) and combined [publication closure](evidence/stage0-host-oracle-publication-closure-2026-08-18.json); acoustic matrix remains absent | the pure-host oracle covers only frozen frame/timing boundary semantics; it is not acoustic, realtime, device or governed-corpus evidence. Physical/acoustic execution and the overall PoC remain blocked |
...
| POC-DECISION-001 | BLOCKED | XL | Decision revision graph benchmark | POC-GATES-001, POC-DATA-001 | merged [decision-revision projection host-oracle evidence](evidence/poc-decision-001/decision-revision-projection-host-oracle-local-evidence-stage0-v0.1.json) and combined [publication closure](evidence/stage0-host-oracle-publication-closure-2026-08-18.json); ≥100 governed adjudicated cases, source validator and scoring remain absent | the pure-host projection oracle validates deterministic revision/user-ownership semantics only; it is not benchmark, quality, corpus or model evidence and cannot make a decision final automatically |
...
| POC-OFFLINE-001 | TODO | L | Airplane/no-GMS core dependency audit | selected local harnesses; prospective [`poc-offline-readiness-stage0-v0.1`](stage0/DORA_MVP1_POC_OFFLINE_READINESS_CONTRACT_STAGE0_V0_1.md), [machine record](evidence/poc-offline-001/readiness-contract-stage0-v0.1.json), merged I1/I2 pure-host evidence, [I2 independent advisory review](evidence/poc-offline-001/reviews/off-i2-integrated-synthetic-harness-independent-advisory-review-2026-08-18.json) and combined [publication closure](evidence/stage0-host-oracle-publication-closure-2026-08-18.json) | the merged dependency-free I1 oracle and in-memory I2 harness prove a bounded synthetic semantics subset only. All 10 readiness blockers remain open (`0` closed); calibrated call ledger, exact device matrix, approved local model, durable product integration and OS-blocked physical execution remain absent / `NOT_READY` / `NOT_RUN` / `NOT_AUTHORIZED` | zero app-attributed forbidden calls and usable local core still require later calibrated/device evidence; host semantics, static absence and repository CI are not an Offline PASS |
